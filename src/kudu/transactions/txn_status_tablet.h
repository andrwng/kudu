...
class TxnStatusTablet {
 public:
  static const char* kTxnIdColName;
  static const char* kEntryTypeColName;
  static const char* kIdentifierColName;
  static const char* kMetadataColName;
  static const char* kTxnStatusTableName;
