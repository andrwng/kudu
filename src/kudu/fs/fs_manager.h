...
class FsManager {
 ...
 private:
  ...
  FRIEND_TEST(MiniTabletServerTest, TestFsLayoutEndToEnd);
  // For access to directory names:
  friend class itest::ExternalMiniClusterFsInspector;
  friend class tserver::MiniTabletServerTest_TestFsLayoutEndToEnd_Test;
