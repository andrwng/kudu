...
class FsManager {
 public:
  ...
  //
  // This callback will be run when block operations run into disk failures.
  // The input to the callback is expected to be the UUID of a failed DataDir.
