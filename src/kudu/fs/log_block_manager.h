...
// directory group appropriate for the block, as indicated by hints in the
// CreateBlockOptions (e.g. blocks for diskrowsets should be placed within
// its tablet's data directory group).
//
...
class LogBlockManager : public BlockManager {
 ...
 private:
  ...
  // Returns a randomly-selected container within the data directory group
  // appropriate for the given CreateBlockOptions, creating a new container
  // if necessary.
  //
