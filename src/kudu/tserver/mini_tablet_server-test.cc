...
//
// Users may want to move the metadata directory away from the default WAL root,
// or may want to abide by the new default from a younger version of Kudu that
// only has metadata in the first data root. Both of these cases are tested.
